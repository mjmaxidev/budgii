...
export const seedWatchlistItems: WatchlistItem[] = [
  ...
  {
    id: 'wl_4',
    name: 'Nature Made Multivitamin (Men)',
    merchant: 'Costco',
    currentPrice: 17.49,
    status: 'watching',
    imageUrl: '',
  ...
  {
    id: 'wl_5',
    name: 'Air Fryer Liners (100 Pack)',
    merchant: 'Walmart',
    currentPrice: 6.98,
    originalPrice: 9.98,
    status: 'new_deal',
...
export const seedDeals: Deal[] = [
  {
    id: 'deal_1',
    watchlistItemId: 'wl_x1',
    name: 'Huggies Ultra Dry Nappies Size 4',
  ...
  {
    id: 'deal_2',
    watchlistItemId: 'wl_x2',
    name: 'OMO Ultimate Laundry Liquid 2L',
    merchant: 'Woolworths',
    originalPrice: 18.99,
    salePrice: 11.9,
    discountPercent: 37,
  ...
  {
    id: 'deal_3',
    watchlistItemId: 'wl_x3',
    name: "Kellogg's Nutri-Grain Cereal 765g",
    merchant: 'Coles',
    originalPrice: 8.0,
    salePrice: 5.0,
    discountPercent: 38,
  ...
  {
    id: 'deal_4',
    watchlistItemId: 'wl_x4',
    name: "Swisse Women's Ultivite 60 Tablets",
    merchant: 'Priceline',
    originalPrice: 27.99,
    salePrice: 19.59,
    discountPercent: 30,
  ...
  {
    id: 'deal_5',
    watchlistItemId: 'wl_x5',
    name: 'Finish All In 1 Max Dishwasher Tablets 80pk',
    merchant: 'ALDI',
    originalPrice: 21.99,
    salePrice: 14.99,
    discountPercent: 32,
  ...
  {
    id: 'deal_6',
    watchlistItemId: 'wl_x6',
    name: 'Berocca Performance Effervescent 45 Tablets',
    merchant: 'Chemist Warehouse',
    originalPrice: 26.99,
    salePrice: 17.49,
    discountPercent: 35,
