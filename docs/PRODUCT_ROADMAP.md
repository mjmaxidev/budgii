...
| ---------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Recurring transactions | Config UI, sync, backend apply, idempotent due expense creation, `startDate`, active/paused toggle, next due, last applied metadata, and manual preview/apply controls | Background scheduler/cron and user-facing background failure status                                                                                                                      |
...
| Recurring Transactions | Synced config + backend apply-on-hydration, visible schedule status, and manual preview/apply controls | Needs background scheduler                                                |
