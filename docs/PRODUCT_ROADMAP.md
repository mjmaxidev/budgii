...
| ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Recurring transactions | Config UI, sync, backend apply, idempotent due expense creation, `startDate`, active/paused toggle, next due, and last applied metadata | Background scheduler/cron, manual “apply due now”/preview, user-facing failure status                                                                                                    |
...
| Recurring Transactions | Synced config + backend apply-on-hydration plus visible schedule status | Needs background scheduler and manual apply/preview controls              |
...
- Add preview/apply-now controls.
